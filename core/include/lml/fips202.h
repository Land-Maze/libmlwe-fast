...
/*
 * This header and the corresponding implementation file was grabbed from the public repository https://github.com/PQClean/PQClean
 * From the last commit being 3730b32
 *
 * Minor changes were made from original code
 */
