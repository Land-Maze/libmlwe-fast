\chapter{Performance Evaluation and Benchmark Analysis}
...
\begin{table}[htbp]
    \centering
    \caption{Benchmarking hardware and software environment details. \newline [Source: Own Work]}
    \label{tab:bench_env}
    \begin{tabular}{ll}
        \toprule
...
\begin{table}[htbp]
    \centering
    \caption{Benchmarking results for CRYSTALS-Kyber operations ($N = 5000$ samples, times in nanoseconds). \newline [Source: Own Work]}
...
\begin{figure}[htbp]
    ...
    \caption{Keypair generation performance comparison: Average execution times with standard deviation (left) and full statistical distribution box plot (right). \newline [Source: Own Work]}
...
\begin{figure}[htbp]
    ...
    \caption{Encapsulation performance comparison: Average execution times with standard deviation (left) and full statistical distribution box plot (right). \newline [Source: Own Work]}
...
\begin{figure}[htbp]
    ...
    \caption{Decapsulation performance comparison: Average execution times with standard deviation (left) and full statistical distribution box plot (right). \newline [Source: Own Work]}
