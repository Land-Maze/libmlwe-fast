...
This chapter establishes the mathematical and computational foundations necessary for this thesis. It begins by defining the complexity classes that underpin modern cryptography, analyzes the specific threats posed by quantum computing, and finally details the lattice-based structures and algorithms, specifically Module-LWE and the Number Theoretic Transform, that enable secure and efficient post-quantum communication.
...
\begin{figure}[htbp]
    ...
    \caption{Bloch Sphere Visualisation. \newline\centering[Source: Nielsen \& Chuang~\cite{nielsen2010quantum}]}
...
The Learning With Errors (LWE) problem, introduced by Regev~\cite{regev2005lattices}, is essentially the cryptographic realization of the Closest Vector Problem (CVP).
...
To achieve the "Fast Implementation" goal of this thesis, we utilize Module-LWE (M-LWE)~\cite{langlois2015worst}. M-LWE balances the high security of standard LWE with the efficiency of structured variants like Ring-LWE~\cite{LyubashevskyPR13}.
