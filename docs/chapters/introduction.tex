...
We specifically focus on the mathematical structures used in the CRYSTALS-Kyber algorithm~\cite{kyber_spec_2021}, analyzing how the Number Theoretic Transform (NTT) and vectorized instructions (SIMD Instructions) can be leveraged to achieve high-speed execution.
...
The goal of this thesis is to implement and optimize the core operations of M-LWE based cryptographic schemes, with a focus on the CRYSTALS-Kyber algorithm.
