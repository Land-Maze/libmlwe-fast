        ...
        configs = [
            {
                ...
                "build_type": bt,
                "variant": "Base",
                "cmake_flags": f"-DCMAKE_BUILD_TYPE={bt} -DBUILD_BENCHMARK=ON -DAVX2=OFF -DAVX512=OFF",
                "filter": '"*"',
                "skip": False,
            },
            {
                ...
                "build_type": bt,
                "variant": "AVX2",
                "cmake_flags": f"-DCMAKE_BUILD_TYPE={bt} -DBUILD_BENCHMARK=ON -DAVX2=ON -DAVX512=OFF",
                "filter": '"*[mlwe-fast]*"',
                "skip": args.skip_avx2,
            },
            {
                ...
                "build_type": bt,
                "variant": "AVX-512",
                "cmake_flags": f"-DCMAKE_BUILD_TYPE={bt} -DBUILD_BENCHMARK=ON -DAVX2=OFF -DAVX512=ON",
                "filter": '"*[mlwe-fast]*"',
